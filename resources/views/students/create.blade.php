    ...
    <div class="row">
        <div class="col">
            <div class="card shadow">
                <form class="form" action="{{route('student.store')}}" id="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('nisn') }}" maxlength="10" class="form-control " name="nisn" id="nisn">
                            @error('nisn')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('nis') }}" maxlength="8" class="form-control " name="nis" id="nis">
                            @error('nis')
                            <div class="invalid-feedback d-block">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('phone_number') }}" maxlength="14" class="form-control " name="phone_number" id="phone_number">
                            @error('phone_number')
                            <div class="invalid-feedback d-block">{{$message}}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                               <div class="input-group-prepend">
                                ...
                                <input class="form-control datepicker-second" value="{{ old('birthdate') }}" placeholder="Select date" type="text" name="birthdate" id="birthdate">
                            </div>
                            @error('birthdate')
                            <div class="invalid-feedback d-block">{{$message}}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <select name="fee_id" id="fee" class="form-control select2 pt-3">
                                @foreach ($fees as $fee)
                                <option value="{{$fee->id}}">{{$fee->year_label}} - {{$fee->fee_label}}</option>
                                @endforeach
                            </select>
                            @error('fee_id')
                            <div class="invalid-feedback d-block">{{$message}}</div>
